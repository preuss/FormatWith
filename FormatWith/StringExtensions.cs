...
namespace FormatWith {
	...
	public static class StringExtensions {
		...
		/// <returns>The formatted string</returns>
		public static string FormatWith(this string formatString, Func<string, ReplacementArgument, ReplacementResult> handler) {
		...
		/// <param name="closeBraceChar">The character used to end parameters</param>
		/// <returns>The formatted string</returns>
		public static string FormatWith(this string formatString,
